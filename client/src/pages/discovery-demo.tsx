...
const initialNodes: Node[] = [
  ...
  { id: 'agents', type: 'processing', position: { x: 1150, y: 350 }, data: { label: 'BLL', sub: 'Intelligence', icon: <Sparkles className="w-6 h-6" />, shape: 'circle' } },
      ...
      eds.map((edge) => {
         ...
         if (isComplete) {
            ...
            if (pipelineStep === 3 && (
                ...
                (edge.source === 'dcl' && edge.target === 'analytics')
              )) { 
                active = true; 
                stroke = '#0bcad9'; 
